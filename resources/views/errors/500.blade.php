...
<body class="min-h-screen bg-gradient-to-br from-red-50 via-white to-gray-50 flex items-center justify-center px-6">
    <div class="text-center max-w-md">
        <div class="float text-8xl mb-6 select-none">⚙️</div>
        <p class="text-red-200 font-black text-8xl leading-none mb-2 select-none">500</p>
        <h1 class="text-2xl font-bold text-gray-800 mb-3">Erreur serveur</h1>
